...
function Train() {
  ...
  return (
    <section>
        <div className='relative flex items-center min-h-[40vh] px-10 md:px-20 bg-[#07292F] bg-right bg-cover mx-3 rounded-lg justify-center'>
        <div className='space-y-3'>
            ...
            <p className='text-foreground w-[300px] leading-tight'>You’re in control. Train your aiDR on elements of your Marketing strategy.</p>

            {/* Grid Container */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 mt-6 items-center">
                    {
